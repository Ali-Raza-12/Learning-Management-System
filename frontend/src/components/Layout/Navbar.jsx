...
import { Search, ShoppingCart, Menu, X, ChevronDown, GraduationCap as Graduation, BookOpen } from 'lucide-react';
          ...
          <div className="hidden lg:flex items-center space-x-6 xl:space-x-8">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-64 pl-10 pr-4 py-2 rounded-full border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all duration-200"
              />
            </div>
        ...
        <div className="lg:hidden">
          <div className="px-4 pt-2 pb-3 space-y-1 bg-white border-t border-gray-100">
            ...
            <div className="py-2">
              ...
              >
                <span>Categories</span>
                <ChevronDown className={`h-4 w-4 transform transition-transform ${isCategoryOpen ? 'rotate-180' : ''}`} />
              </button>
              {isCategoryOpen && (
                <div className="mt-2 space-y-1">
                  {categories.map((category) => (
                    <Link
                      key={category}
                      to={`/category/${category.toLowerCase()}`}
                      className="block px-3 py-2 text-gray-600 hover:bg-gray-50 rounded-lg ml-4"
                    >
                      {category}
                    </Link>
                  ))}
