            ...
            <ul className="space-y-2.5">
              {quickLinks.map((link) => (
                <li key={link.name}>
                  <Link
                    to={link.href}
                    className="flex items-center group text-base hover:text-blue-400 transition-colors"
                  >
            ...
            <ul className="space-y-4">
              <li>
                <a
                  ...
                  className="flex items-center text-base hover:text-blue-400 transition-colors"
                >
