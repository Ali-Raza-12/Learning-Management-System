      ...
      <div className="w-full h-auto px-[40px] my-10 flex flex-col gap-6">
          ...
          <div className="w-full h-auto flex flex-col gap-[40px]">
            ...
            <div className="w-full h-auto flex flex-col gap-[24px]">
              <div className="flex flex-col gap-[17px]">
                <h1 className="font-inter text-grey9 font-bold text-[40px] leading-[140%] ">
              ...
              <div className="w-full h-auto flex flex-col gap-[24px]">
                <p className="flex gap-[5px] text-warning">
                  4.6
                  <span className="flex gap-[5px] text-grey7">
                    <img src={ratings} alt="ratings" /> (651651 rating)
                  </span>
                ...
                <div className="flex gap-[5px] items-center">
                  ...
                  <p className="text-grey7">
                    Created by
                    <span className="text-primary6">Ronal Richards</span>
                  </p>
                </div>
              ...
              <div className="w-[664px] h-[57px] flex gap-[24px]">
                <p className="px-[21px] py-[18px] rounded-[8px] text-grey9 border border-grey3">
                  Description
                </p>
                <p className="px-[21px] py-[18px] rounded-[8px] text-grey9 border border-grey3">
                  Instructor
              ...
              <div className="w-full h-auto flex flex-col gap-[24px]">
                <div className="w-full h-auto flex flex-col gap-[24px]">
                  <div className="flex flex-col gap-[4px]">
                    <h4 className="text-grey9 font-semibold">
                      Course Description
                    </h4>
                    <p className="text-grey7">
                  ...
                  <div className="flex flex-col">
                    <div className="w-[806px] h-auto p-[24px] flex justify-between gap-[16px] border-t border-l border-r border-grey3 rounded-t-lg">
                      <div className="flex gap-[16px]">
                        <img
                          src={downChev}
                          className="w-[24px] h-[24px] border border-grey7"
                          alt="downarrow"
                        />
                        <h5 className="text-grey9 font-semibold">
          ...
          <div className="w-[400px] h-[508px] flex flex-col items-center py-5 justify-between rounded-[16px] border border-grey3">
            ...
            <div className="flex flex-col gap-[24px] border-b-grey7">
              ...
              <div className="flex flex-col gap-[16px]">
                <button className="w-[352px] h-[48px] px-[24px] py-[10px] rounded-lg bg-gray-900 text-white">
                  Add To Cart
                </button>
                <button className="w-[352px] h-[48px] px-[24px] py-[10px] rounded-lg border border-gray-900 text-grey9">
                  Buy Now
                </button>
              </div>
            </div>
              ...
              <div className="flex items-center gap-20 max-w-[949px] h-40 px-2 rounded-[16px] border border-grey3">
                ...
                <div className="w-full h-auto flex flex-col gap-2 mt-1">
                  ...
                  <p className="text-grey7">
                    ...
                    modules. The video lectures were engaging, and the
                    real-world examples really helped solidify my understanding.
                  </p>
                </div>
              </div>
        ...
        <div className="w-full h-auto mb-10">
          <div className="flex justify-between">
            <p className="text-2xl text-grey9 font-bold">
              What Our Customer Say
              <br />
              <span>About Us</span>
            </p>
            <div className="flex gap-[6px]">
              <button className="bg-grey3 px-[16px] py-[10px] rounded-[8px]">
          ...
          <div className="flex flex-wrap lg:flex-nowrap gap-[8px] mt-[25px]">
            {Testimonials.map((testimonial, index) => (
              <div
                key={index}
                className="mt-4 flex flex-col gap-[8px] p-[24px] rounded-[16px] border border-grey3 shadow-md"
              >
                <img
        ...
        <div className="w-full h-auto flex flex-col mb-10">
          ...
          <div className="flex flex-wrap justify-between">
            {TopCourses.map((course, index) => (
              <div
                key={index}
                className="mt-6 p-[8px] border border-gray-300 rounded-[16px] flex flex-col gap-[8px]"
              >
                <img src={course.img} alt="course-img" />
                <div className="flex flex-col gap-[8px]">
                  <p className="text-base text-grey9 font-bold">
                    {course.title}
                  </p>
                  <p className="font-light text-grey7">{course.subheading}</p>
                  <div className="flex gap-[8px]">
                    <img src={course.rate[0].img} alt="img" />
                    <p className="text-sm text-grey7 font-normal">
                      {course.rate[0].title}
                    </p>
                  </div>
